...
const translations = {
  en: {
    ...
    announce_text_html: '<i class="ph-duotone ph-waves"></i> Best time to visit: <strong>November – May</strong> (dry season) — Plan your trip today!',
    ...
    chat_suggest_1: '<i class="ph-duotone ph-car"></i> How to get there?',
    chat_suggest_2: '<i class="ph-duotone ph-calendar"></i> Best time to visit?',
    chat_suggest_3: '<i class="ph-duotone ph-umbrella"></i> Best beaches?',
    chat_suggest_4: '<i class="ph-duotone ph-coins"></i> Budget tips?',
    chat_suggest_5: '<i class="ph-duotone ph-waves"></i> Tibu Tidal Pool?',
    ...
    gal_filter_beach: '<i class="ph-duotone ph-umbrella"></i> Beaches',
    gal_filter_falls: '<i class="ph-duotone ph-drop"></i> Waterfalls',
    gal_filter_nature: '<i class="ph-duotone ph-leaf"></i> Nature',
    gal_filter_landmark: '<i class="ph-duotone ph-bank"></i> Landmarks',
    ...
    map_tab_town: '<i class="ph-duotone ph-buildings"></i> Town Center',
    map_tab_bay: '<i class="ph-duotone ph-waves"></i> Casiguran Bay',
    map_tab_region: '<i class="ph-duotone ph-map-trifold"></i> Aurora Region',
    map_openbtn: "↗ Open in Google Maps",
    card_location: '<i class="ph-light ph-map-pin"></i> Location',
    loc_address_html: "Municipality of Casiguran<br>Province of Aurora<br>Region III – Central Luzon<br>Philippines",
    loc_badge: '<i class="ph-duotone ph-globe"></i> Pacific Rim Municipality',
    card_howtogetthere: '<i class="ph-light ph-compass"></i> How to Get There',
    ...
    route_bus_time: '<i class="ph-duotone ph-clock"></i> ~8–9 hrs total',
    ...
    route_car_time: '<i class="ph-duotone ph-clock"></i> ~6–7 hrs',
    ...
    route_boat_time: '<i class="ph-duotone ph-clock"></i> ~2–3 hrs by sea',
    ...
    route_fly_time: '<i class="ph-duotone ph-clock"></i> ~1 hr flight + transfer',
    card_besttime: '<i class="ph-light ph-calendar"></i> Best Time to Visit',
    season_dry_month: '<i class="ph-duotone ph-sun"></i> Mar – May',
    season_dry_desc: "Dry season — ideal for beaches and waterfalls.",
    season_cool_month: '<i class="ph-duotone ph-sun"></i> Nov – Feb',
    season_cool_desc: "Cool and less humid, great for trekking.",
    season_rain_month: '<i class="ph-duotone ph-cloud-rain"></i> Jun – Aug',
    season_rain_desc: "Rainy season. Some roads may flood.",
    season_typhoon_month: '<i class="ph-duotone ph-hurricane"></i> Sep – Oct',
    season_typhoon_desc: "Typhoon season — avoid if possible.",
    card_traveltips: '<i class="ph-light ph-lightbulb"></i> Travel Tips',
    ...
    card_nearbytowns: '<i class="ph-light ph-map-trifold"></i> Nearby Towns',
    town_baler: '<i class="ph-duotone ph-umbrella"></i> Baler, Aurora',
    dist_baler: "~80 km south",
    town_dipaculao: '<i class="ph-duotone ph-waves"></i> Dipaculao, Aurora',
    dist_dipaculao: "~50 km south",
    town_palanan: '<i class="ph-duotone ph-leaf"></i> Palanan, Isabela',
    dist_palanan: "~70 km north",
    town_sanmariano: '<i class="ph-duotone ph-mountains"></i> San Mariano, Isabela',
    dist_sanmariano: "~120 km northwest",
    town_cabanatuan: '<i class="ph-duotone ph-plant"></i> Cabanatuan, Nueva Ecija',
    ...
    filter_all: "All",
    filter_featured: '<i class="ph-duotone ph-star"></i> Featured',
    filter_beach: '<i class="ph-duotone ph-umbrella"></i> Beaches',
    filter_nature: '<i class="ph-duotone ph-leaf"></i> Nature',
    filter_landmark: '<i class="ph-duotone ph-bank"></i> Landmarks',
    noresults_text: "No spots found for",
    section_featured_title: "Featured Spots",
    section_featured_tag: '<i class="ph-duotone ph-star"></i> Must-Visit',
    section_beaches_title: "Beaches",
    section_beaches_tag: '<i class="ph-duotone ph-umbrella"></i> Coastal',
    section_nature_title: "Nature Attractions",
    section_nature_tag: '<i class="ph-duotone ph-leaf"></i> Eco',
    section_landmarks_title: "Landmarks",
    section_landmarks_tag: '<i class="ph-duotone ph-bank"></i> Heritage',
    ...
    form_label: '<i class="ph-light ph-envelope"></i> Send an Inquiry',
    ...
    card_reachus: '<i class="ph-light ph-map-pin"></i> Reach Us',
    ...
    card_response: '<i class="ph-light ph-clock"></i> Response Time',
    ...
    card_beforemsg: '<i class="ph-light ph-map-trifold"></i> Before You Message',
  ...
  tl: {
    ...
    announce_text_html: '<i class="ph-duotone ph-waves"></i> Pinakamagandang oras bumisita: <strong>Nobyembre – Mayo</strong> (tag-init) — Planuhin na ang biyahe mo!',
    ...
    chat_suggest_1: '<i class="ph-duotone ph-car"></i> Paano makarating?',
    chat_suggest_2: '<i class="ph-duotone ph-calendar"></i> Kailan pinakamagandang bumisita?',
    chat_suggest_3: '<i class="ph-duotone ph-umbrella"></i> Anong pinakamagandang beach?',
    chat_suggest_4: '<i class="ph-duotone ph-coins"></i> Budget tips?',
    chat_suggest_5: '<i class="ph-duotone ph-waves"></i> Tibu Tidal Pool?',
    ...
    gal_filter_beach: '<i class="ph-duotone ph-umbrella"></i> Dalampasigan',
    gal_filter_falls: '<i class="ph-duotone ph-drop"></i> Talon',
    gal_filter_nature: '<i class="ph-duotone ph-leaf"></i> Kalikasan',
    gal_filter_landmark: '<i class="ph-duotone ph-bank"></i> Makasaysayan',
    ...
    map_tab_town: '<i class="ph-duotone ph-buildings"></i> Sentro ng Bayan',
    map_tab_bay: '<i class="ph-duotone ph-waves"></i> Casiguran Bay',
    map_tab_region: '<i class="ph-duotone ph-map-trifold"></i> Rehiyon ng Aurora',
    map_openbtn: "↗ Buksan sa Google Maps",
    card_location: '<i class="ph-light ph-map-pin"></i> Lokasyon',
    loc_address_html: "Munisipyo ng Casiguran<br>Lalawigan ng Aurora<br>Rehiyon III – Gitnang Luzon<br>Pilipinas",
    loc_badge: '<i class="ph-duotone ph-globe"></i> Bayan sa Gilid ng Pasipiko',
    card_howtogetthere: '<i class="ph-light ph-compass"></i> Paano Makarating',
    ...
    route_bus_time: '<i class="ph-duotone ph-clock"></i> ~8–9 oras total',
    ...
    route_car_time: '<i class="ph-duotone ph-clock"></i> ~6–7 oras',
    ...
    route_boat_time: '<i class="ph-duotone ph-clock"></i> ~2–3 oras sa dagat',
    ...
    route_fly_time: '<i class="ph-duotone ph-clock"></i> ~1 oras na flight + transfer',
    card_besttime: '<i class="ph-light ph-calendar"></i> Pinakamagandang Oras Bumisita',
    season_dry_month: '<i class="ph-duotone ph-sun"></i> Mar – May',
    season_dry_desc: "Tag-init — perpekto para sa dalampasigan at talon.",
    season_cool_month: '<i class="ph-duotone ph-sun"></i> Nob – Peb',
    season_cool_desc: "Malamig at hindi masyadong halumigmig, magandang panahon para sa trekking.",
    season_rain_month: '<i class="ph-duotone ph-cloud-rain"></i> Hun – Ago',
    season_rain_desc: "Tag-ulan. May mga daan na baha-baha.",
    season_typhoon_month: '<i class="ph-duotone ph-hurricane"></i> Set – Okt',
    season_typhoon_desc: "Panahon ng bagyo — iwasan kung maaari.",
    card_traveltips: '<i class="ph-light ph-lightbulb"></i> Mga Travel Tips',
    ...
    card_nearbytowns: '<i class="ph-light ph-map-trifold"></i> Mga Karatig na Bayan',
    town_baler: '<i class="ph-duotone ph-umbrella"></i> Baler, Aurora',
    ...
    filter_all: "Lahat",
    filter_featured: '<i class="ph-duotone ph-star"></i> Featured',
    filter_beach: '<i class="ph-duotone ph-umbrella"></i> Dalampasigan',
    filter_nature: '<i class="ph-duotone ph-leaf"></i> Kalikasan',
    filter_landmark: '<i class="ph-duotone ph-bank"></i> Makasaysayan',
    noresults_text: "Walang nahanap na spot para sa",
    section_featured_title: "Mga Featured Spot",
    section_featured_tag: '<i class="ph-duotone ph-star"></i> Dapat Bisitahin',
    section_beaches_title: "Mga Dalampasigan",
    section_beaches_tag: '<i class="ph-duotone ph-umbrella"></i> Baybayin',
    section_nature_title: "Mga Atraksyon sa Kalikasan",
    section_nature_tag: '<i class="ph-duotone ph-leaf"></i> Eco',
    section_landmarks_title: "Mga Makasaysayang Lugar",
    section_landmarks_tag: '<i class="ph-duotone ph-bank"></i> Pamana',
    ...
    form_label: '<i class="ph-light ph-envelope"></i> Magpadala ng Inquiry',
    ...
    card_reachus: '<i class="ph-light ph-map-pin"></i> Makipag-ugnayan',
    reach_office_title: "Casiguran Municipal Tourism Office",
    reach_office_desc: "Munisipyo, Casiguran, Aurora, Pilipinas",
    reach_fb_title: "Facebook Page",
    reach_email_title: "Email",
    card_response: '<i class="ph-light ph-clock"></i> Oras ng Pagsagot',
    ...
    card_beforemsg: '<i class="ph-light ph-map-trifold"></i> Bago Mag-mensahe',
